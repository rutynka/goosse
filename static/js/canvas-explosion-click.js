!(function () {
        ...
        _createClass(ConfettiWorld, [
            {
                ...
                value: function init() {
                    this.objects = [];
                    let $imgNames = [...document.querySelectorAll('figure img')];
                    $imgNames.map(el => el.addEventListener('click', this.explode.bind(this)));
            ...
            },
            {
                ...
                value: function explode(event) {
                    ...
                    this.objects.push(new Explosion(this, x, y-30));
                },
            },
            {
                key: "clearExplosion",
    ...
    element.style.cssText = "position:fixed;top:0;left:0;z-index:5;pointer-events: none;";
